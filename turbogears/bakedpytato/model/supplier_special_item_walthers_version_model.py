...
class SupplierSpecialItemWalthersVersionModel(BaseModel, DefaultMixin, SupplierSpecialItemVersionMixin):
	__tablename__ = 'supplier_special_item_walthers_versions'
