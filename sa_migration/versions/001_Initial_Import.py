...
data.append({
	...
	'columns': [
		...
		{'name':'name', 'type_':String, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'name', 'type_':String, 'nullable':True, 'index':True},
		{'name':'address_country_id', 'type_':UUID(), 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'address_country_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'address_province_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	'name':'cake_sessions',
	'columns': [
		{'name':'id', 'type_':String(255), 'primary_key':True,'nullable':False},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'scale_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'manufacturer_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'category_id', 'type_':Integer, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'sort', 'type_':Integer, 'nullable':False, 'server_default':'0', 'index':True},
		...
		{'name':'supplier_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'lft', 'type_':Integer, 'nullable':True, 'index':True},
		{'name':'name', 'type_':String, 'nullable':False, 'index':True},
		{'name':'parent_id', 'type_':Integer, 'nullable':True, 'index':True},
		{'name':'pathx', 'type_':String, 'nullable':True},
		{'name':'product_count', 'type_':Integer, 'nullable':True},
		{'name':'rght', 'type_':Integer, 'nullable':True},
		{'name':'root_id', 'type_':Integer, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'category_id', 'type_':Integer, 'nullable':True, 'index':True},
		{'name':'manufacturer_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'needle', 'type_':String, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'order', 'type_':Integer, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'name', 'type_':String, 'nullable':True, 'index':True},
		{'name':'serial', 'type_':Integer, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'customer_incidental_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'customer_order_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'customer_order_id', 'type_':UUID, 'nullable':False, 'index':True},
		...
		{'name':'line_number', 'type_':Integer, 'nullable':True, 'index':True},
		{'name':'lock', 'type_':Boolean, 'nullable':False, 'server_default':'False'},
		{'name':'mutable', 'type_':Boolean, 'nullable':False, 'server_default':'True'},
		{'name':'price', 'type_':Numeric, 'nullable':True},
		{'name':'product_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'customer_order_source_id', 'type_':UUID, 'nullable':True, 'index':True},
		...
		{'name':'identifier', 'type_':String, 'nullable':True, 'index':True},
		{'name':'legacy_flag', 'type_':Integer, 'nullable':False, 'server_default':'0'},
		{'name':'mutable', 'type_':Boolean, 'nullable':False, 'server_default':'True'},
		...
		{'name':'void', 'type_':Boolean, 'nullable':False, 'server_default':'False'},
		{'name':'warehouse_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'customer_order_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'customer_payment_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'lock', 'type_':Boolean, 'nullable':False, 'server_default':'False'},
		{'name':'mutable', 'type_':Boolean, 'nullable':False, 'server_default':'True'},
		{'name':'price', 'type_':Numeric, 'nullable':True},
		{'name':'serial', 'type_':Integer, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'customer_order_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'customer_shipment_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'customer_payment_source_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'customer_order_id', 'type_':UUID,'nullable':False, 'index':True},
		{'name':'customer_order_item_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'customer_shipment_id', 'type_':UUID,'nullable':False, 'index':True},
		{'name':'legacy_flag', 'type_':Integer, 'nullable':False, 'server_default':'0'},
		{'name':'mutable', 'type_':Boolean, 'nullable':False, 'server_default':'True'},
		{'name':'product_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'warehouse_id', 'type_':UUID, 'nullable':False, 'index':True},
		{'name':'shipped', 'type_':Date, 'nullable':True},
		{'name':'label', 'type_':String, 'nullable':True, 'index':True},
		{'name':'identifier', 'type_':String, 'nullable':True, 'index':True},
		{'name':'shipper_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'mutable', 'type_':Boolean, 'nullable':False, 'server_default':'True'},
		{'name':'name', 'type_':String, 'nullable':True},
		{'name':'sha256', 'type_':String(64), 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'name', 'type_':String, 'nullable':True},
		{'name':'sha256', 'type_':String(64), 'nullable':False, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'inventory_audit_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'product_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'inventory_transfer_id', 'type_':UUID, 'nullable':False, 'index':True},
		{'name':'product_id', 'type_':UUID, 'nullable':False, 'index':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'date', 'type_':Date,'nullable':False},
		{'name':'from_warehouse_id', 'type_':UUID, 'nullable':False, 'index':True},
		{'name':'inventory_transfer_item_count', 'type_':Integer, 'nullable':True},
		{'name':'to_warehouse_id', 'type_':UUID, 'nullable':False, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'lock', 'type_':Boolean, 'nullable':False, 'server_default':'False'},
		{'name':'manufacturer_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'manufacturer_identifier', 'type_':String, 'nullable':True, 'index':True},
		{'name':'supplier_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'payment_source_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'manufacturer_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'normal', 'type_':Boolean, 'nullable':False, 'server_default':'True', 'index':True},
		{'name':'preorder', 'type_':Boolean, 'nullable':False, 'server_default':'True', 'index':True},
		{'name':'rank', 'type_':Integer, 'nullable':True},
		{'name':'retail_high', 'type_':Numeric, 'nullable':False, 'server_default':'NaN', 'index':True},
		{'name':'retail_low', 'type_':Numeric, 'nullable':False, 'server_default':'0', 'index':True},
		...
		{'name':'special', 'type_':Boolean, 'nullable':False, 'server_default':'True', 'index':True},
		{'name':'supplier_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		{'name':'id', 'type_':UUID, 'primary_key':True,'nullable':False},
		{'name':'product_id', 'type_':UUID, 'nullable':False, 'index':True},
		{'name':'barcode', 'type_':String, 'nullable':True, 'index':True},
		{'name':'created', 'type_':DateTime, 'nullable':True},
		{'name':'modified', 'type_':DateTime, 'nullable':True},
		{'name':'creator_id', 'type_':UUID, 'nullable':True},
		{'name':'modifier_id', 'type_':UUID, 'nullable':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'lock', 'type_':Boolean, 'nullable':False, 'server_default':'false'},
		{'name':'product_id', 'type_':UUID, 'nullable':True, 'index':True},
		{'name':'product_identifier', 'type_':String, 'nullable':True, 'index':True},
		{'name':'manufacturer_id', 'type_':UUID, 'nullable':True, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'date', 'type_':Date, 'nullable':False, 'index':True},
...
data.append({
	...
	'columns': [
		...
		{'name':'inventory_audit_shrink', 'type_':Numeric, 'nullable':True},
		{'name':'inventory_audit_total', 'type_':Numeric, 'nullable':True},
		{'name':'month', 'type_':Integer, 'nullable':False, 'index':True},
		{'name':'product_id', 'type_':UUID, 'nullable':False, 'index':True},
		{'name':'supplier_shipment_quantity', 'type_':Numeric, 'nullable':True},
		{'name':'supplier_shipment_total', 'type_':Numeric, 'nullable':True},
		{'name':'year', 'type_':Integer, 'nullable':False, 'index':True},
	],
})
...
data.append({
	...
	'columns': [
		{'name': 'id', 'type_':UUID, 'primary_key':True, 'nullable':False},
		{'name': 'package_product_id', 'type_': UUID, 'nullable':False, 'index':True},
		{'name': 'product_id', 'type_': UUID, 'nullable':True, 'index':True},
